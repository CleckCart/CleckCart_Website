        ...
        <div class="col p-5 text-end">
          <div class="mt-2">
            <form class="d-flex" role="search" method="POST" action="">
              <input type="text" name="searchShop" placeholder="Search for shop" class="form-control border border-dark" value="<?php
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              ...
              <p>You are about to delete shop(s). This process cannot be undone</p>
            </div>
