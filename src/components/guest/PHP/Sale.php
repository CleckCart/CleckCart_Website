                    ...
                    while($row = oci_fetch_array($result, OCI_ASSOC)){
                        ...
                        if($discountAmount == 0){
                            ...
                            echo("<div class='on-sale p-2'style='position:absolute;background-color:#C41E3A;color:#ffffff;'><b>$discountAmount %</b></div>
                                <a class = 'text-decoration-none' href = './DiscountProductDetail.php?id=$id&name=$productName&description=$productDescription&image=$productImage&price=$productPrice&newPrice=$discountedPrice&stock=$productStock'>
                                ...
                                <div class='d-flex flex-row flex-wrap p-1 align-self-center w-100'>
                                    <a class='btn btn-productsize btn-primary btn-outline-dark w-50' href='./DiscountCartProducts.php?&id=$id&image=$productImage&name=$productName&description=$productDescription&price=$productPrice&newPrice=$discountedPrice&stock=$productStock&quantity=1' role='button'><img src = './../../../dist/public/cart2.svg' style='filter: invert(100%) sepia(0%) saturate(7482%) hue-rotate(83deg) brightness(97%) contrast(109%);'alt = 'cart2'/></a>
                                    <a class='btn btn-productsize btn-primary btn-outline-dark w-50' href='./WishListProducts.php?&id=$id&image=$productImage&name=$productName&description=$productDescription&price=$productPrice' role='button'><img src = './../../../dist/public/heart2.svg' style='filter: invert(100%) sepia(0%) saturate(7482%) hue-rotate(83deg) brightness(97%) contrast(109%);'  alt = 'cart2'/></a>
                                </div>");
                                echo("</div>");
                                echo("</div>");
                            }
