...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class = "container">
        <div class = "row m-4 p-4 g-4 text-center ">
            ...
            <div class="row p-3 ">
                <h6 class="text-muted">Please enter the email address you used when creating an account with us.</h6>
            </div>
        </div>
                    ...
                    <form method = "POST" action = "./ForgotpasswordSubmit.php">
                        ...
                        <?php }?>
                            ...
                            <div class="mb-3 col">
                                ...
                                <input type="email" class="form-control" placeholder="Enter Email Address" aria-label="Email" name = "CustomerRegisteredEmail">
                            </div>
                        
                        
                            <div class="mb-3 col mt-4">
                                <input type="submit" class="btn btn-success w-100" name = "CustomerEmailSubmit" value="Reset Password">
                            </div>
                       
                        
                            <div class="mb-3 col mt-3">
                            <p class = "text-muted mb-5">Back to Login? <a href = "./CustomerLogin.php" class="link-dark text-success">Customer Login</a> Or <a href="../../trader/PHP/TraderLogin.php" class="link-dark text-success">Trader Login</a></p>
                            </div>
