...
<body>
    ...
    <div class="container bg-light border rounded mt-5 mb-5">
        ...
        <div class = "row">
                ...
                <div class="col-sm-4">
                    <?php echo("<form method = 'POST' action = './VerifyEmailOtpProcessCheckout.php?cartId=$guestCartId&totalCartItems=$productTotalQuantity&collectionDate=$collectionDate&collectionTime=$collectionTime'>") ?>
                        <?php
                            if(isset($_GET['error'])) {?>
