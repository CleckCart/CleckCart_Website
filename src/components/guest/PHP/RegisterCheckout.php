...
<body>
    ...
    <div class="container-fluid p-5">
        <div class = "row row-cols-1 row-cols-md-2 g-4">
            ...
            <div class="col">
                <?php echo("<form method = 'POST' action = 'RegisterCheckoutSubmit.php?cartId=$guestCartId&totalCartItems=$productTotalQuantity&collectionDate=$collectionDate&collectionTime=$collectionTime'>") ?>
                    <?php
                        if(isset($_GET['error'])) {?>
