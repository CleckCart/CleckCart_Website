...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container">
        <div class="row m-4 p-4 g-4 text-center ">
            ...
            <!-- <div class="row p-3 ">
                <h6 class="text-muted">Change your password</h6>
            </div> -->
        </div>
        <div class="row row-cols-3 ">
            ...
            <div class="col-sm-4">
                ...
                <form method="POST" action="./UpdatepasswordSubmit.php">
                    <?php
                    if (isset($_GET['error'])) { ?>
                    ...
                    <div class="mb-3 col">
                        <label for="exampleInputText1" class="form-label">Enter New Password</label>
                        <div class="input-group">
                            <input type="password" class="form-control" placeholder="Enter New Password" id="password1" name="UserNewPassword">
                    ...
                    <div class="mb-3 col">
                        ...
                        <div class="input-group">
                            <input type="password" class="form-control" placeholder="Confirm New Password" id="password2" name="UserConfirmNewPassword">
                            <span class="input-group-text" id="togglePassword">
                    ...
                    <div class="mb-3 col mt-4">
                        <input type="submit" class="btn btn-primary w-100" name="UserUpdatepasswordSubmit" value="Update Password">
                    </div>
