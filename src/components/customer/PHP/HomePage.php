...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-my-custom-color">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <img src="../public/logo.png" class="img-fluid" width = "70" height="70" alt="logo">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="d-flex mb-2 mb-lg-0 list-unstyled">
                        <li class="nav-item me-3">
                            <a class="nav-link" href="#"><img src="../public/search.svg" alt="search"></a>
                        </li>
                        <li class="nav-item me-3">
                            <a class="nav-link" href="#"><img src="../public/heart.svg" alt="heart"></a>
                        </li>
                        <li class="nav-item me-3 ">
                            <a class="nav-link" data-bs-toggle="modal" data-bs-target="#exampleModal"  href="#"><img src="../public/person.svg" alt="person"></a>
                                <!-- Modal -->
                        ...
                        <li class="nav-item me-3">
                            <a class="nav-link" href="#"><img src="../public/cart.svg" alt="cart"></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner h-75" >
            ...
            <img src="../public/1.jpg" class="d-block w-100" alt="...">
            ...
            <img src="../public/2.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
    ...
    <div class = "container-fluid">
            <div class="row row-cols-2 row-cols-md-4 g-4">
                <div class="col mt-5 text-center">
                    <div class= "d-flex justify-content-center">
                        <div class="ellipse p-5">
                            <img src="../public/package.svg" alt="package">
                        </div>
                    </div>
                ...
                <div class="col mt-5 text-center">
                    <div class= "d-flex justify-content-center">
                        <div class="ellipse p-5">
                            <img src="../public/carrot.svg" alt="carrot">
                        </div>
                    </div>
                ...
                <div class="col mt-5 text-center">
                    <div class= "d-flex justify-content-center">
                        <div class="ellipse p-5">
                            <img src="../public/badge.svg" alt="badge">
                        </div>
                    </div>
                ...
                <div class="col mt-5 text-center">
                    <div class= "d-flex justify-content-center">
                        <div class="ellipse p-5">
                            <img src="../public/customersupport.svg" alt="ellipse">
                        </div>
                    </div>
            ...
            <div class="col p-5">
                <div class="card">
                    ...
                    <div class="d-flex flex-row flex-wrap p-2 align-self-center w-100">
                        <a class="btn btn-productsize btn-primary btn-outline-dark w-50" href="#" role="button"><img src = "../public/cart2.svg" alt = "cart2"/></a>
                        <a class="btn btn-productsize btn-primary btn-outline-dark w-50" href="#" role="button"><img src = "../public/heart2.svg" alt = "cart2"/></a>
                    </div>
                </div>
            </div>
            <div class="col p-5">
            ...
            <div class="row row-cols-2 row-cols-md-4 g-4">
                <div class="col mt-5 text-center">
                        <div class="d-flex flex-column bd-highlight mb-3">
                            ...
                            <div class="d-flex flex-row flex-wrap p-2 align-self-center">
                                <a class="nav-link p-5" href="#"><img src="../public/twitter.svg" alt="twitter"></a>
                                <a class="nav-link p-5" href="#"><img src="../public/facebook.svg" alt="facebook"></a>
                                <a class="nav-link p-5" href="#"><img src="../public/instagram.svg" alt="instagram"></a>
                            </div>
                        </div>
                </div>
                <div class="col mt-5 text-center">
                ...
                <div class="col mt-5 text-center">
                        <div class="d-flex flex-column bd-highlight mb-3">
                            ...
                            <div class="p-2 bd-highlight">
                                <a class="nav-link text-reset text-decoration-none" href="#"><img src="../public/location.svg" alt="twitter"> lorem ipsum </a>
                                <a class="nav-link text-reset text-decoration-none" href="#"><img src="../public/call.svg" alt="call"> lorem ipsum </a>
                                <a class="nav-link text-reset text-decoration-none" href="#"><img src="../public/message.svg" alt="instagram"> lorem ipsum </a>
                            </div>
                        </div>
                </div>
            </div>
