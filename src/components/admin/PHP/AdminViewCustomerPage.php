    ...
    <div class="row bg-success headingContainer">
      ...
      <div class="col mt-5 text-end">
        <form method="POST" action="">
          <input type="text" name="searchCustomer" placeholder="Search a customer" class="border border-dark" value="<?php
          if (isset($_POST['searchCustomer'])) {
          echo (trim($_POST['searchCustomer']));
          }
          ?>">
          <input type="submit" name="searchCustomerSubmit" value="Search">
        </form>
      </div>
    </div>
